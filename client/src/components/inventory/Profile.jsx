    ...
    <div className="pb-6">
        ...
        <div className="mt-4 text-center">
            ...
            <div className="flex flex-row justify-center w-full mx-auto space-x-2 text-center">
                ...
                <div className=" font-bold tracking-wide text-gray-600  dark:text-gray-300 font-mono text-xl">Diseñador UI / Front-end</div>
            ...
            <div className="w-full text-center">
                <div className="flex justify-center pt-8 pb-0 lg:pt-4">
                    <div className="flex space-x-2">
                        <a
                            className="p-1 -m-1 text-gray-400 hover:text-custom-twitter focus:outline-none focus-visible:ring-2 ring-primary"
                        ...
                        <a className="p-1 -m-1 text-gray-400 hover:text-black focus:outline-none focus-visible:ring-2 ring-primary" href="https://www.github.com/Smilesharks" rel="noopener" aria-label="Ariel Cerda on Github" >
                        ...
                        <a
                            className="p-1 -m-1 text-gray-400 hover:text-custom-blue focus:outline-none focus-visible:ring-2 ring-primary"
                        ...
                        <a
                            className="p-1 -m-1 text-gray-400 hover:text-custom-instagram focus:outline-none focus-visible:ring-2 ring-primary"
        ...
        <div className="pt-6 mx-6 mt-6 text-center border-t border-gray-200 dark:border-gray-700/50">
            <div className="flex flex-wrap justify-center">
                <div className="w-full px-6">
                    <p className="mb-2 font-light leading-relaxed text-gray-600 dark:text-gray-400">
                        Lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin turpis orci, maximus sed purus
                    </p>
                </div>
            </div>
        </div>
        <div className="relative h-6 overflow-hidden md:translate-y-28    rounded-b-xl">
  <div className="absolute  flex -space-x-10 rounded-b-2xl">
    ...
    <div className="w-28 h-8 transition-colors duration-200 delay-150 transform skew-x-[35deg] bg-teal-100/90 group-hover:bg-teal-400/90 z-30"></div>
    <div className="w-28 h-8 transition-colors duration-200 delay-200 transform skew-x-[35deg] bg-teal-50/90 group-hover:bg-teal-200/90 z-40"></div>
    <div className="w-28 h-8 transition-colors duration-200 delay-300 transform skew-x-[35deg] bg-teal-100/90 group-hover:bg-teal-200/90 z-50"></div>
  </div>
</div>
